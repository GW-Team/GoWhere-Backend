...
ActiveRecord::Schema.define(version: 2018_05_08_150801) do
  ...
  create_table "attraction_photos", force: :cascade do |t|
    t.integer "attraction_id"
    t.string "path"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["attraction_id"], name: "index_attraction_photos_on_attraction_id"
  end
  ...
  create_table "chatroom_messages", force: :cascade do |t|
    ...
    t.index ["child_id"], name: "index_chatroom_messages_on_child_id"
